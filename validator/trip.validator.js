...
const xCoordinateValidate = body('xCoordinate').notEmpty().isNumeric().withMessage('제목을 입력해주세요.');
const yCoordinateValidate = body('xCoordinate').notEmpty().isNumeric().withMessage('제목을 입력해주세요.');
